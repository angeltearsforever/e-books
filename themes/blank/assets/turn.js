                ...
                switch (b.effect) {
                    ...
                    case "sheet":
                        ...
                        var N = c.opts.acceleration,
                            ...
                            first = true,//VERY HACKY SOLUTION REMOVE THIS LINE
                            H = function () {
                                first = false;//VERY HACKY SOLUTION REMOVE THIS LINE
                                var b =
                                    j(0, 0),
                                    f = j(0, 0);
                                b.x = d.x ? d.x - a.x : a.x;
                                ...
                                //VERY HACKY SOLUTION REMOVE first FROM BELOW
                                if (first && g > K && (m.x += Math.abs(m.y * b.y / b.x), m.y = 0, Math.round(m.x * Math.tan(J - g)) < h)) return a.y = Math.sqrt(Math.pow(h, 2) + 2 * f.x * b.x), D && (a.y = h - a.y), H();
